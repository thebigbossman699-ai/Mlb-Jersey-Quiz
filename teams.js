const teams = [
    {
        ...
        roster: [
            ...
            { pos: "b3", number: 28, player: "Eugenio Suárez", label: "3B" },
    ...
    },
    {
        ...
        roster: [
            ...
            { pos: "b2", number: 7, player: "Andrés Giménez", label: "2B" },
            { pos: "b3", number: 11, player: "José Ramírez", label: "3B" },
    ...
    },
    {
        ...
        roster: [
            ...
            { pos: "ss", number: 3, player: "Jeremy Peña", label: "SS" },
            ...
            { pos: "c", number: 15, player: "Martín Maldonado", label: "C" }
        ]
    },
    {
    ...
    },
    {
        ...
        roster: [
            ...
            { pos: "rf", number: 22, player: "Jesús Sánchez", label: "RF" },
            ...
            { pos: "ace", number: 28, player: "Jesús Luzardo", label: "ACE" },
    ...
    },
    {
        ...
        roster: [
            ...
            { pos: "ace", number: 49, player: "Pablo López", label: "ACE" },
    ...
    },
    {
        ...
        roster: [
            ...
            { pos: "b2", number: 2, player: "Yandy Díaz", label: "2B" },
            ...
            { pos: "dh", number: 43, player: "Harold Ramírez", label: "DH" },
            { pos: "c", number: 28, player: "René Pinto", label: "C" }
        ]
    },
    {
        name: "Texas Rangers",
    ...
    },
    {
        ...
        roster: [
            ...
            { pos: "b2", number: 48, player: "Luis Urías", label: "2B" },
